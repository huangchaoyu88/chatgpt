...
For new DOCX creation and major rewrites, use a design preset unless a selected template, supplied design reference, or requested visual system applies. For existing-document edits, preserve the original and make minimal local edits.
